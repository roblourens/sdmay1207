...
public class CameraStreamer extends MediaRecorder
{
    ...
    public void setup(SurfaceHolder holder, String ip, int resX, int resY,
            int fps, NetworkController netController) throws IOException
    {
        ...
        try
        {
            ...
            vstream = new H263Packetizer(getInputStream(),
                    InetAddress.getByName(ip), 7476, netController);
        } catch (IOException e)
        {
